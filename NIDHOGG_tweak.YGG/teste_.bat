...
echo.                                                                           
echo.                                                                                                                                    
echo.                                                                              %w% YGG Is Checking for Administrative Privelages...   %b%  
echo.                                                                                                                                    
echo.                                                                        
...
echo. 
echo. 
echo.                                                                                           %W%   tweak is not running as Admin!
echo.                                         
...
chcp 437 >nul
powershell "Checkpoint-Computer -Description 'Tweak Restore Point'
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Restore point completed successfully, press "OK" to continue', Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 
cls
goto :resources
...
cls
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloading resources (power plan, Nvidia profile inspector & more, Press "OK" To continue)', 'YGG Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
cls 
...
echo.
echo.
echo. %w% Downloading Resources Used by the tool... (You can find them in the C:\ygg folder, they are all trusted apps used by thousands of people) %b%                                                       
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "%temp%\ygg.zip" "https://github.com/ygg4L/yggresources/raw/49a210cc246950fbe006397db88d11ef1447e4c1/8.0.zip" 
cls
Powershell -NoProfile Expand-Archive '%temp%\ygg.zip' -DestinationPath 'C:\ygg' >nul 2>&1 
cls

powershell "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloaded resources successfully, Press "OK" To continue to the menu! ', 'YGG Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.                                                                                                                                                                                 
echo.                                                  %p%[%w%10%p%]%w% Fix Corrupted Files                 %p%[%w%11%p%]%w% Uninstall Useless Apps                %p%[%w%12%p%]%w% YGG Network Tweaking Utility           
echo.                                                                                                                                                                                 
echo.                                           
echo.                                                                                                                                                                                 
echo.                                                  %p%[%w%F%p%]%w% Fixes                                %p%[%w%W%p%]%w% Completely Optimize Your PC            %p%[%w%P%p%]%w% Use Restore Point
echo.                                                                                                                                                                                 
echo.                                                  %p%[%w%R%p%]%w% Reverts                              %p%[%w%X%p%]%w% Exit The Utility                       %p%[%w%E%p%]%w% YGG Tweaks 
echo.                                                                                                                                                                                   
echo.                                                                                                                                                                                                  
echo.                                                                                                                                                                                 
echo.                                           
...
cls 
md C:\ygg >nul 2>&1
echo %w% - Refreshing ygg resource folder %b%
timeout /t 1 /nobreak > NUL
del /s /q C:\ygg  >nul 2>&1
...
echo.
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Make sure to restart your pc after using, so the tweaks properly apply, thanks for using the ygg utility. Press "ok" to exit', 'YGG Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
pause > nul
cls
...
echo.
echo.                                                             %w%  Made and distributed by YGG TWEAKS, S.R.O. ® 2025 * Version 2.0 * Updated 9th of January 2025 
echo.
echo.                                                                 
echo.
...
if /i %input% == T start https://www.youtube.com/watch?v=oWeBJlxSe2Q&ab_channel=ygg
...
:n14
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('!WARNING! You can only use this if you are on ethernet, if you are on wifi, press "N" on the next page', 'YGG Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.                                                                                
echo.                                                           %p%[%w%4%p%]%w% Disable SSD Power Savings 
echo.
echo.                                                           %p%[%w%5%p%]%w% Optimize FUSTIL Settings for SSD's
echo.  
echo.
echo.                                                                                           
echo.                                                                       %p%[%w%M%p%]%w% Back to menu         
...
:s1
echo %w% - Defragmenting Boot Drive (If it takes too long, feel free to close the utility and skip this, the tweaks save if you close so you can start where you left off) %b%
...
:7war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Note: If you want to revert anything, you can do it in our revert category on the main page of the utility', 'YGG Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('After you press ok it will open an app, Go to the LOGON section, Disabling all services except: antivirus, cmd.exe, and the n/a services', 'YGG Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1

start C:\ygg\Autoruns.exe
echo.
echo.
echo.
echo.                                                                                  %b%  
...
echo.
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Note: Disabling Windows Updates will break Microsoft store, if you want to use it again simply press "Enable" in windows update blocker ', 'YGG Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
start C:\ygg\Windows_Update_Blocker.exe
echo. 
echo.
echo.
echo.                                                                                  %b%  
...
:5war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Do NOT do these if your pc has bad overheating issues', 'YGG Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
...
echo.                                                             %p%[%w%M%p%]%w% Back to menu    
echo.                           
echo.                                                                     echo.                                                     %w% Select which type of Gpu you have:  
echo. 
...
:2war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Do NOT do these if your pc has overheating issues', 'YGG Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
:2
...
echo.                                                                      %p%[%w%A%p%]%w% Apply All 
echo.                                             
echo.                                                            %p%[%w%1%p%]%w% Apply YGG Free Power Plan V6               
echo.                                                                                           
...
echo %w% Import YGG Free Power Plan V6%b%
powercfg -import "C:\ygg\YGG Free Power Plan V6.pow"
powercfg.cpl
...
:pg1
:pg3
::there are not many nvidia specific power saving features, most are disabled via nvidia profile inspector
...
echo %w% - Applying YGGTWEAKS Nvidia Profile Inspector Profile (optimizes nvidia control panel 3D settings and much more) %b%
start "" /wait "C:\ygg\nvidiaProfileInspector.exe" "C:\ygg\Free NVPI YGG Profile V7.nip" 
...
echo %w% - Enabing MSI mode on usb%b%
echo %w% - Deleting USB Device Priority (may show an error if you have it deleted already) %b%
for /f %%i in ('wmic path Win32_USBController get PNPDeviceID') do set "str=%%i" & (
Reg.exe delete "HKLM\System\CurrentControlSet\Enum\%%i\Device Parameters\Interrupt Management\Affinity Policy" /v "DevicePriority" /f
...
echo.                                                                                                                                                                                   
echo.                                                                                                                                                                                  
echo.                                                         %p%%p%%p%%w%  Made and distributed by YGG TWEAKS, S.R.O. ® 2024 * Version 8.1 * Updated 7th of February 2025                   
echo.                                                                                                                                                                                 
echo.                                           
